...
system ("sh Rscriptdesc_R.sh");

# processing the blind prediction file
system ("cut -d\",\" -f1 desc_top100 > molid");
system ("sed 's/\"//g' Blind_pred_desc.txt > Blind_pred_desc1");
system ("sed 's/NT/\t\tNT/g' Blind_pred_desc1 > Blind_pred_desc2");
system ("cut -f 2- Blind_pred_desc2 > Blind_pred_desc3");
system ("paste molid Blind_pred_desc3 > Blind_pred_desc4");
system ("rm -fr Blind_pred_desc.txt Blind_pred_desc1 Blind_pred_desc2 Blind_pred_desc3 molid");
system ("mv Blind_pred_desc4 Blind_pred_desc.txt");
system ("tail -1 Blind_pred_desc.txt > score_file");
system ("sed 's/\t/,/g' score_file > desc_score");
...
system ("paste -d ',' desc_score sol_score1 per_score1 > score_file1");
system ("cut -f1 -d',' score_file1 > molid");
system ("cut -d ',' -f 3- score_file1 > scores");
system ("paste -d',' molid scores > score_file");
system ("cat final_header score_file > scores_desc.txt");
system ("mv scores_desc.txt prediction/");
system ("rm Blind_pred_desc.txt  desc_top100  fingerprints fingerprintsn  permeability_top5  Prediction_score2  scores sol1_score desc desc.txt     fingerprints1 Header per_score score_file sol_score1 desc_score final_desc   fingerprints.log  molid per_score1 score_file1 script_1.py sol_top40");
